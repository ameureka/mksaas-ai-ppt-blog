...
1. **[完整技术分析](../04-modules/payment/analysis.md)** - 完整的技术分析报告 (54KB)
2. **[流程图和架构图](../04-modules/payment/diagrams.md)** - 详细的流程图和架构图
3. **[快速参考指南](../04-modules/payment/quick-reference.md)** - 快速参考指南和调试工具

---

## 文档导航

### 1. 完整技术分析 (payment/analysis.md)
...
### 3. 快速参考指南 (payment/quick-reference.md)
