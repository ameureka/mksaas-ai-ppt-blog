...
#### 支付和学分相关
- **[支付和学分系统详细分析](../04-modules/payment/analysis.md)** (原 PAYMENT_CREDITS_ANALYSIS.md)
- **[支付流程图示](../04-modules/payment/diagrams.md)** (原 PAYMENT_CREDITS_DIAGRAMS.md)
- **[支付学分快速参考](../04-modules/payment/quick-reference.md)** (原 PAYMENT_CREDITS_QUICK_REFERENCE.md)
...
**支付和学分系统**
→ 阅读：[支付积分完整分析](../04-modules/payment/analysis.md) 或 [支付积分快速参考](../04-modules/payment/quick-reference.md)
