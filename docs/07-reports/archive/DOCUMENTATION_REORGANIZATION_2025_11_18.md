...
1. **docs/07-reports/** - 存放项目状态报告和质量验证
...
#### 新手入门（第1天）
1. 根目录 README.md
2. docs/00-getting-started/
3. docs/01-architecture/ANALYSIS_SUMMARY.md

#### 深入理解（第2-3天）
1. docs/01-architecture/PROJECT_ANALYSIS_REPORT.md
2. docs/02-concepts/ 数据库文档
3. docs/04-modules/ 支付和积分系统

#### 开发实战（第4-5天）
1. docs/03-guides/
2. docs/05-reference/QUICK_REFERENCE.md
3. QA/ 相关问答
...
```bash
# 架构文档
git mv ARCHITECTURE_DIAGRAM.md PROJECT_ANALYSIS_REPORT.md ANALYSIS_INDEX.md ANALYSIS_SUMMARY.md "docs/01-architecture/"

# 数据库文档
git mv DATABASE_ARCHITECTURE_ANALYSIS.md DB_ANALYSIS_README.md DB_QUICK_REFERENCE.md DB_MIGRATION_EVOLUTION.md "docs/02-concepts/"

# 支付和积分文档
git mv PAYMENT_CREDITS_ANALYSIS.md PAYMENT_CREDITS_DIAGRAMS.md PAYMENT_CREDITS_QUICK_REFERENCE.md "docs/04-modules/"

# 快速参考文档
git mv QUICK_REFERENCE.md AGENTS.md "docs/05-reference/"

# 报告文档
git mv PROJECT_STATUS_2025_11_18.md COMPLETION_REPORT.md QUALITY_VALIDATION_REPORT.md CHECKPOINT.md docs/07-reports/
