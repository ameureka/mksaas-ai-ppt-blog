...
import { Search, Clock, Eye, ArrowRight, BookOpen, TrendingUp, Palette, FileText } from "lucide-react"
...
const blogPosts = [
  {
    ...
    excerpt: "商务汇报、教育培训、产品营销...不同场景该选哪种PPT？本文详解8大分类的特点和适用场景，帮你3分钟找到最合适的模板。",
    category: "入门指南",
  ...
  },
  {
    ...
    excerpt: "15分钟汇报需要多少页PPT？根据哈佛商学院研究，演讲时长与页数有最佳比例。本文提供详细的时长-页数对照表。",
    category: "设计技巧",
    tags: ["页数规划", "演讲技巧", "时间管理"],
    readTime: 6,
    views: 8920,
